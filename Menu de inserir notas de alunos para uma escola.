...
import java.util.Locale;
 /* Código de: Marcus Victor dos Santos Coelho */

public class Main {
    static Scanner scanner = new Scanner(System.in);
    static Locale ptBr = new Locale("pt", "BR");
    
   //Método/Função para calcular a média da linha da matriz
    ...
    double soma = 0, media = 0;
        ...
        media = 0;
            for(int n=0; n<4; n++){
                ...
                System.out.printf("A média do %dº aluno é: %.1f\n", m + 1, media);
        } 
    return media;
    }
    ...
    public static void main(String[] args) {
        //Variáveis
        int escolha = 0, qtdAlunos = 1, qtdNotas = 4;
        double[][] notas;
        double media = 0, soma = 0;
            //Quantidade de alunos
            System.out.println("Primeiro diga quantos alunos você tem?: ");
            qtdAlunos = scanner.nextInt();
            notas = new double[qtdAlunos][qtdNotas];
            //Menu
            while(escolha != 9) {
            System.out.println("---------- Escola Jesuítas | PORTAL DO PROFESSOR ----------");
            System.out.println("| 1 - Inserir notas || 2 - Visualizar notas || 3 - Calcular média || 9 - Sair do sistema |");
            ...
            switch(escolha) {
                    case 1: //Inserir notas
                        ...
                        for(int i=0; i<notas.length; i++) {
                            System.out.printf("As notas do %dº aluno |\n", i + 1);
                    ...
                    break;
                        case 2: //Visualizador de notas
                            System.out.println("Aviso ao docente! Se alguma nota for menor que '3', ela será anulada.");
                        ...
                        break;
                            ...
                            break;
                                ...
                                break;
            default: //quando o usuário inserir uma opção que não não existente em casos
